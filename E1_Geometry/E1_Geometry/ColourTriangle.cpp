...
void ColourTriangle::initBuffers(ID3D11Device* device)
{
	...
	//vertices[0].position = XMFLOAT3(0.0f, 1.0f, 0.0f);  // Top of triangle
	...
	D3D11_BUFFER_DESC vertexBufferDesc = { sizeof(VertexType_Texture) * vertexCount, D3D11_USAGE_DEFAULT, D3D11_BIND_VERTEX_BUFFER, 0, 0, 0 };//Bonus
...
void ColourTriangle::sendData(ID3D11DeviceContext* deviceContext, D3D_PRIMITIVE_TOPOLOGY top)
{
	...
	stride = sizeof(VertexType_Texture);//Bonus
	offset = 0;
